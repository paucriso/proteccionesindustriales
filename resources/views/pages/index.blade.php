...
@section('content')
    ...
    <!-- Hero Section -->
    <section id="hero" class="bg-cover bg-center h-60 flex items-center justify-between px-8 md:px-16" style="background-image: url('https://placehold.co/1600x600');">
    ...
    <section class="py-12">
        <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
                <img src="https://placehold.co/600x400" alt="Protecciones industriales" class="w-full rounded-lg shadow-lg">
            </div>
        </div>
    </section>
    ...
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white p-6 shadow-lg">
                <img src="https://placehold.co/600x400" alt="Protecciones industriales" class="w-full h-40 object-cover rounded-lg mb-4">
            ...
            <!-- Servicio 2 -->
            <div class="bg-white p-6 shadow-lg">
                <img src="https://placehold.co/600x400" alt="Mesas de trabajo" class="w-full h-40 object-cover rounded-lg mb-4">
            ...
            <!-- Servicio 3 -->
            <div class="bg-white p-6 shadow-lg">
                <img src="https://placehold.co/600x400" alt="Carros transportadores" class="w-full h-40 object-cover rounded-lg mb-4">
            ...
            <!-- Servicio 5 -->
            <div class="bg-white p-6 shadow-lg">
                <img src="https://placehold.co/600x400" alt="Protección para columnas" class="w-full h-40 object-cover rounded-lg mb-4">
            ...
            <!-- Servicio 7 -->
            <div class="bg-white p-6 shadow-lg">
                <img src="https://placehold.co/600x400" alt="Protección para racks tipo bota" class="w-full h-40 object-cover rounded-lg mb-4">
            ...
            <!-- Servicio 8 -->
            <div class="bg-white p-6 shadow-lg">
                <img src="https://placehold.co/600x400" alt="Protección perimetral" class="w-full h-40 object-cover rounded-lg mb-4">
            ...
            <!-- Servicio 9 -->
            <div class="bg-white p-6 shadow-lg">
                <img src="https://placehold.co/600x400" alt="Puertas de seguridad abatibles" class="w-full h-40 object-cover rounded-lg mb-4">
            ...
            <!-- Servicio 11 -->
            <div class="bg-white p-6 shadow-lg">
                <img src="https://placehold.co/600x400" alt="Mamparas de acero" class="w-full h-40 object-cover rounded-lg mb-4">
