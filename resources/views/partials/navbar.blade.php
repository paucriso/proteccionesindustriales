<nav class="bg-gray-100 text-white" x-data="{ open: false }">
    ...
    <div class="container mx-auto flex justify-between items-center py-2 px-4">
        ...
        <div class="hidden lg:flex items-center w-1/2">
            <form action="{{route('products.busqueda')}}" method="POST" class="flex w-full">
                @csrf
                @method('POST')
                <input type="text" name="query" placeholder="Buscar..."
                    value="{{ request('query') }}"
                    class="w-full px-4 py-2 rounded-l bg-gray-300 text-gray-700 focus:outline-none">
                <button type="submit" class="bg-[#2e5282] p-2 rounded-r hover:bg-blue-600 focus:outline-none">
            ...
            <div class="flex justify-between items-center h-12">
                ...
                <div class="relative">
                    ...
                    <ul class="hidden lg:flex lg:space-x-10 lg:items-center tracking-wide">
                        <li><a href="{{ route('pages.index') }}" class="hover:text-gray-400">Inicio</a></li>
                        <li><a href="{{ route('products.index') }}" class="hover:text-gray-400">Productos</a></li>
                        <li><a href="{{ route('pages.nosotros') }}" class="hover:text-gray-400">Nosotros</a></li>
                        <li><a href="{{ route('pages.blog') }}" class="hover:text-gray-400">Blog</a></li>
                        <li><a href="{{ route('pages.contacto') }}" class="hover:text-gray-400">Contacto</a></li>
                    </ul>
                </div>
    ...
    <div x-show="open"
        ...
        <div class="container mx-auto px-4 py-2">
            <ul class="space-y-2">
                <li><a href="{{ route('pages.index') }}" class="block py-2 text-white hover:text-gray-400">Inicio</a></li>
                <li><a href="{{ route('products.index') }}" class="block py-2 text-white hover:text-gray-400">Productos</a></li>
                <li><a href="{{ route('pages.nosotros') }}" class="block py-2 text-white hover:text-gray-400">Nosotros</a></li>
                <li><a href="{{ route('pages.blog') }}" class="block py-2 text-white hover:text-gray-400">Blog</a></li>
                <li><a href="{{ route('pages.contacto') }}" class="block py-2 text-white hover:text-gray-400">Contacto</a></li>
            </ul>
        </div>
    </div>
</nav>
